...
export const dictionary: Record<string, string> = {
  ...
  'Visualizes each month using its exact calendar days, dividing bank interest days from days you truly own your home. Watch your freedom day advance earlier every year.':
    'Visualise chaque mois selon son nombre réel de jours calendaires, divisant les jours pour la banque des jours où vous êtes pleinement propriétaire. Observez votre jour de liberté financière avancer chaque année.',
  ...
  'Weekly Extra': 'Supplément hebdomadaire',
  'Bi-Weekly Extra': 'Supplément bihebdomadaire',
  'Semi-Monthly Extra': 'Supplément bimensuel',
